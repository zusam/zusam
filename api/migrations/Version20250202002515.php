...
final class Version20250202002515 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        , created_at INTEGER NOT NULL, value VARCHAR(255) NOT NULL, PRIMARY KEY(id), CONSTRAINT FK_A4D707F7F675F31B FOREIGN KEY (author_id) REFERENCES "user" (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_A4D707F7537A1329 FOREIGN KEY (message_id) REFERENCES "message" (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
