...
final class Version20220302172143 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IF EXISTS IDX_MESSAGEPREVIEWID');
        $this->addSql('DROP INDEX IF EXISTS UNIQ_MESSAGESECRETKEY');
        $this->addSql('DROP INDEX IF EXISTS IDX_MESSAGEAUTHORID');
        $this->addSql('DROP INDEX IF EXISTS IDX_MESSAGEGROUPID');
        $this->addSql('DROP INDEX IF EXISTS IDX_MESSAGEPARENTID');
        ...
        $this->addSql('DROP INDEX IF EXISTS IDX_FILEID');
        $this->addSql('DROP INDEX IF EXISTS IDX_MESSAGEID');
        ...
        $this->addSql('DROP INDEX IF EXISTS IDX_NOTIFMESSAGEID');
        $this->addSql('DROP INDEX IF EXISTS IDX_NOTIFGROUPID');
        $this->addSql('DROP INDEX IF EXISTS IDX_NOTIFUSERID');
        $this->addSql('DROP INDEX IF EXISTS IDX_NOTIFMINIATUREID');
        $this->addSql('DROP INDEX IF EXISTS IDX_NOTIFOWNERID');
        $this->addSql('DROP INDEX IF EXISTS UNIQ_NOTIFSECRETKEY');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IF EXISTS UNIQ_8C9F36107F4741F5');
        $this->addSql('CREATE TEMPORARY TABLE __temp__file AS SELECT id, created_at, type, status, content_url, size, file_index, secret_key FROM "file"');
        $this->addSql('DROP TABLE "file"');
        ...
        $this->addSql('INSERT INTO "file" (id, created_at, type, status, content_url, size, file_index, secret_key) SELECT id, created_at, type, status, content_url, size, file_index, secret_key FROM __temp__file');
        $this->addSql('DROP TABLE __temp__file');
        $this->addSql('DROP INDEX IF EXISTS UNIQ_6DC044C57F4741F5');
