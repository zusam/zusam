...
const util = {
    ...
    thumbnail: (url, width, height) => url ? "/api/images/thumbnail/" + width + "/" + height + "/" + util.getId(url) : null,
    // same as http.thumbnail but for a crop
    crop: (url, width, height) => url ? "/api/images/crop/" + width + "/" + height + "/" + util.getId(url) : null,
